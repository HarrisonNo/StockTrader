...
std::function<uint32_t(std::string, uint32_t)> debug_purchase_amount_func = debug_purchase_amount_GLOBAL;
std::function<uint32_t(std::string, uint32_t)> debug_sell_amount_func = debug_sell_amount_GLOBAL;